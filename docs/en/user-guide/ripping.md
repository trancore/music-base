...
The CD import screen shows CD drives detected by Windows and whether media is loaded. While the screen is open, it polls periodically and reports CD insertion or removal. Track reading and encoding are later features.
