      ...
      '/ja/': [
        {
          ...
          items: [
            ...
            { text: 'インターネットラジオ', link: '/ja/user-guide/radio' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ADR: 大規模ライブラリ', link: '/ja/developer-guide/adr-001-large-library-cache' },
            { text: 'ADR: プレイリストのパス解決', link: '/ja/developer-guide/adr-002-playlist-path-resolution' },
            { text: 'ADR: プレイリストのフォルダツリー', link: '/ja/developer-guide/adr-003-playlist-folder-tree' },
      ...
      '/en/': [
        {
          ...
          items: [
            ...
            { text: 'Internet radio', link: '/en/user-guide/radio' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'ADR: Large-library cache', link: '/en/developer-guide/adr-001-large-library-cache' },
            { text: 'ADR: Playlist path resolution', link: '/en/developer-guide/adr-002-playlist-path-resolution' },
            { text: 'ADR: Playlist folder tree', link: '/en/developer-guide/adr-003-playlist-folder-tree' },
